...
const CustomersPage = (props: Props) => {
	return (
		<div className='ml-[5rem] min-h-screen dark:bg-slate-900 p-5 bg-slate-200 text-slate-700 dark:text-slate-400 max-w-screen lg:max-screen-lg md:max-w-screen-md'>
